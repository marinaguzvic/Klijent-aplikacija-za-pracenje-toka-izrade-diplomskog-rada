                                ...
                                <div class="row">
                                    <div class="col-sm-3 col-md-6" >
                                        <div class="form-check form-check-inline">
                                            ...
                                            <input type="text" class="form-control" name = "prezime" id="exampleFormControlInput2" placeholder="Prezime">
                                            <label for="exampleFormControlInput3">Broj indeksa</label>
                                            <input type="text" class="form-control" name = "brojindeksa" id="exampleFormControlInput3" placeholder="Broj indeksa">
                                        </div>
                                    </div>
                                    <div class="col-sm-3 col-md-6" >
                                        <div class="form-check form-check-inline">
                                            <label for="exampleFormControlInput4">JMBG</label>
                                            <input type="text" class="form-control" name = "jmbg" id="exampleFormControlInput4" placeholder="JMBG">
                                            <label for="exampleFormControlInput5">Broj telefona</label>
                                            <input type="text" class="form-control" name = "brojtelefona" id="exampleFormControlInput5" placeholder="Broj telefona">
                                            <label for="exampleFormControlInput4">Godina studija</label>
                                            <div class="form-check form-check-inline">
                                                <c:forEach var="godina" begin="1" end="4" step="1">
                                                    <input class="form-check-input" type="checkbox" name = "godinestudija" id="inlineCheckbox1" value="${godina}">
                                                    <label class="form-check-label" for="inlineCheckbox1">${godina}</label>
                                                </c:forEach>
                                            </div>
                                        </div>
                                    </div>
                ...
                <c:choose>
                    ...
                    <c:otherwise>
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <thead>
                                <tr>
                                    <c:forEach var="prop" items="${sessionScope.students.get(0).getCrucialProperties()}">
                                        <th>
                                            ${prop}
                                        </th>
                                    </c:forEach>
                            ...
                            <tbody>
                                <c:forEach var="student" items="${requestScope.students != null? requestScope.students:sessionScope.students}">
                                    <tr onclick="window.location = '/app/controller?studentid=${student.getClanSistemaId()}&action=viewstudent';">
                                        <c:forEach var="prop" items="${student.getCrucialProperties()}">
                                            <td>
                                                ${student.getPropertyByName(prop)}
                                            </td>
                                        </c:forEach>
